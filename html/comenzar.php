...
<body>
    ...
    <div class="logIn">
        <form>
            <h1>Registro</h1>
            <input type="text" class="btn" id="inputN" >
            <label class="nombre btn" for="nombre">Nombre y Apellido</label>
            <input type="email" class="btn" id="inputC" >
            <label class="email btn" for="email">E-mail</label>
            <input type="password" class="btn" id="inputP">
            <label class="pwd btn" for="password">Contraseña</label>
            <input type="submit" class="btn" value="Entre">
            <a href="logIn.html">Ya tienes cuenta</a>
        </form>
        <div class="continua">
            <h1>Continua <b>con</b></h1>
            <button>
    ...
    <div class="contacto">
        ...
        <input type="button" value="CONTACTO" onclick="" />
    </div>
    <!-- footer -->
    <footer>
        <div class="elementos">
